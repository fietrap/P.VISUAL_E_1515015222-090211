...
public boolean TambahData(String judul, String penulis, String harga){
    try{
...
public boolean UbaData(String id, String judul, String penulis, String harga){
    try{
...
public boolean HapusData(String id){
 try{
    ...
    private void initComponents() {
        ...
        simpan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/posttest6/simpan.PNG"))); // NOI18N
        ...
        comboPenulis.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tere Liye", "Shun Oguri", "Takeru Sato", "Hajime Saito" }));
        ...
        ubah.setIcon(new javax.swing.ImageIcon(getClass().getResource("/posttest6/ubah.PNG"))); // NOI18N
        ...
        hapus.setIcon(new javax.swing.ImageIcon(getClass().getResource("/posttest6/hapus.PNG"))); // NOI18N
        ...
        keluar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/posttest6/buang dalam.PNG"))); // NOI18N
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(hapus, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 47, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(simpan))
                .addGap(9, 9, 9)
    ...
    private void simpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_simpanActionPerformed
        ...
        JOptionPane.showMessageDialog(this, "data berhasil tambah");
            ...
            JOptionPane.showMessageDialog(this, "--pilih tabel---", "Kesalahan",JOptionPane.WARNING_MESSAGE);
        }
    ...
    private void ubahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ubahActionPerformed
        ...
        UbaData(id,judul, penulis,harga);
        InitTable();
        TampilData();
        JOptionPane.showMessageDialog(this, "data berhasil ubah");
        }}  catch(Exception e){
            JOptionPane.showMessageDialog(this, "--pilih tabel---", "Kesalahan",JOptionPane.WARNING_MESSAGE);
        }
    ...
    private void hapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hapusActionPerformed
        ...
        else JOptionPane.showConfirmDialog(null, "gagal hapus");
